...
void set_gestor_apuestas_apuestas_realizadas(gestor_apuestas * ga, apuesta ap){ga->apuestas_realizadas[n_apuestas] = ap; n_apuestas ++;}  apuesta apuestas_realizadas[3000];
*//***FIN SETTERS***/
